...
void turbineECalEndcap_autoCalib_analytic_topo::Init(TTree* tree) {
  ...
  fChain->SetBranchAddress("EMECCaloTopoClusterCells.cellID", EMECCaloTopoClusterCells_cellID,
                           &b_EMECCaloTopoClusterCells_cellID);
  fChain->SetBranchStatus("EMECCaloTopoClusterCells.energy", 1);
  fChain->SetBranchAddress("EMECCaloTopoClusterCells.energy", EMECCaloTopoClusterCells_energy,
                           &b_EMECCaloTopoClusterCells_energy);
  ...
  fChain->SetBranchAddress("EMECCaloTopoClusters.hits_begin", EMECCaloTopoClusters_hits_begin,
                           &b_EMECCaloTopoClusters_hits_begin);
  fChain->SetBranchStatus("EMECCaloTopoClusters.hits_end", 1);
  fChain->SetBranchAddress("EMECCaloTopoClusters.hits_end", EMECCaloTopoClusters_hits_end,
                           &b_EMECCaloTopoClusters_hits_end);
  ...
  fChain->SetBranchAddress("EMECCaloTopoClusters.position.z", EMECCaloTopoClusters_position_z,
                           &b_EMECCaloTopoClusters_position_z);
